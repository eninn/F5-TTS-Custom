...
Examples:
    ...
    python prepare_csv_wavs.py /input/dataset/path /output/dataset/path --workers 4
        ...
        input_dir = "/mnt/data/dataset/audio_text/aihubMix"
        output_dir = "./data/ztts_f5_main"
        is_pretrain = True
        workers = 28
        prepare_and_save_set(input_dir, output_dir, is_finetune=not is_pretrain, num_workers=workers)
